  ...
  describe "csv download" do
    ...
    context "with values represented as human readable labels" do
      before do
        ...
        expected_content.sub!(/\{scheme_has_other_client_group\}/, scheme.has_other_client_group.to_s)
    ...
    context "with values represented as codes" do
      before do
        ...
        expected_content.sub!(/\{scheme_has_other_client_group\}/, scheme.has_other_client_group_before_type_cast.to_s)
