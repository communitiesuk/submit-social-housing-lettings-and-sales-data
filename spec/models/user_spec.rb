...
RSpec.describe User, type: :model do
  describe "#new" do
    ...
    context "when the user is a data coordinator" do
      ...
      context "and their organisation has managing agents" do
        ...
        it "can filter lettings logs by user, year, status, managing_organisation and owning_organisation" do
          expect(user.logs_filters).to match_array(%w[years status needstypes assigned_to user uploaded_by managing_organisation owning_organisation uploading_organisation bulk_upload_id managing_organisation_text_search owning_organisation_text_search user_text_search])
        end
      end
    end
    ...
    context "when the user is a Customer Support person" do
      ...
      it "can filter lettings logs by user, year, status, managing_organisation and owning_organisation" do
        expect(user.logs_filters).to match_array(%w[years status needstypes assigned_to user uploaded_by owning_organisation managing_organisation uploading_organisation bulk_upload_id managing_organisation_text_search owning_organisation_text_search user_text_search])
      end
    end
