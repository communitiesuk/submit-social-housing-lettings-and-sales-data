...
RSpec.describe Form::Lettings::Pages::PersonWorkingSituation, type: :model do
  ...
  let(:subsection) { instance_double(Form::Subsection, form: instance_double(Form, start_date: Time.zone.local(2024, 4, 1), start_year_2026_or_later?: false, person_question_count: 4)) }
  let(:person_index) { 2 }
