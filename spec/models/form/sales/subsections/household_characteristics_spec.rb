...
RSpec.describe Form::Sales::Subsections::HouseholdCharacteristics, type: :model do
  ...
  context "with 2024/25 form" do
    before do
      allow(form).to receive_messages(start_date: Time.zone.local(2024, 4, 1), start_year_2025_or_later?: false, start_year_2026_or_later?: false)
    end
  ...
  context "with 2025/26 form" do
    before do
      allow(form).to receive_messages(start_date: Time.zone.local(2025, 4, 1), start_year_2025_or_later?: true, start_year_2026_or_later?: false)
    end
  ...
  context "with 2026/27 form" do
    before do
      allow(form).to receive_messages(start_date: Time.zone.local(2026, 4, 1), start_year_2025_or_later?: true, start_year_2026_or_later?: true)
    end
