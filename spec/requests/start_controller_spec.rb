        ...
        describe "the counts displayed" do
          ...
          context "and logged in as a provider" do
            ...
            it "shows the correct counts of logs created by them" do
              ...
              last_year_logs = build_list(:lettings_log, last_year_in_progress_count, :in_progress, assigned_to: provider_1, startdate: Time.zone.today - 1.year)
              last_year_logs.each { |log| log.save(validate: false) }
            ...
            it "does not include logs created by other users in the count, whether in their organisation or not" do
              last_year_log = build(:lettings_log, :in_progress, assigned_to: coordinator, startdate: Time.zone.today - 1.year)
              last_year_log.save!(validate: false)
          ...
          context "and logged in as a support user" do
            ...
            it "shows the correct counts of all logs from all orgs" do
              ...
              last_year_logs = build_list(:lettings_log, provider_1_lettings_last_year_in_progress_count, :in_progress, assigned_to: provider_1, startdate: Time.zone.today - 1.year)
              last_year_logs.each { |log| log.save(validate: false) }
              ...
              last_year_logs_2 = build_list(:lettings_log, provider_2_lettings_last_year_in_progress_count, :in_progress, assigned_to: provider_2, startdate: Time.zone.today - 1.year)
              last_year_logs_2.each { |log| log.save(validate: false) }
