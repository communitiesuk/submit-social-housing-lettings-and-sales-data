        ...
        context "when there are more than 20 logs" do
          ...
          context "when on the first page" do
            ...
            it "has pagination in the title" do
              expect(page).to have_title("#{user.organisation.name} (page 1 of 2) - Submit social housing lettings and sales data (CORE) - GOV.UK")
            end
          end
          ...
          context "when on the second page" do
            ...
            it "has pagination in the title" do
              expect(page).to have_title("#{user.organisation.name} (page 2 of 2) - Submit social housing lettings and sales data (CORE) - GOV.UK")
            end
          end
        end
      end
