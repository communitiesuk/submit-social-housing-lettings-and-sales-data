  ...
  def field_mapping_for_errors
    {
      ...
      renewal: [:field_6],
      scheme_id: (scheme_field.present? ? [scheme_field] : []),
      scheme: (scheme_field.present? ? [scheme_field] : []),
      location_id: (location_field.present? ? [location_field] : []),
      location: (location_field.present? ? [location_field] : []),
      created_by: [:field_3],
      needstype: [:field_4],
