class BulkUpload::Lettings::Year2026::RowParser
  ...
  QUESTIONS = {
    ...
    field_139: "If 'No', enter lead tenant's gender identity",
    field_140: "Is the gender the person 2 identifies with the same as their sex registered at birth?",
    field_141: "If 'No', enter person 2's gender identity",
    field_142: "Is the gender the person 3 identifies with the same as their sex registered at birth?",
    field_143: "If 'No', enter person 3's gender identity",
    field_144: "Is the gender the person 4 identifies with the same as their sex registered at birth?",
    field_145: "If 'No', enter person 4's gender identity",
    field_146: "Is the gender the person 5 identifies with the same as their sex registered at birth?",
    field_147: "If 'No', enter person 5's gender identity",
    field_148: "Is the gender the person 6 identifies with the same as their sex registered at birth?",
    field_149: "If 'No', enter person 6's gender identity",
    field_150: "Is the gender the person 7 identifies with the same as their sex registered at birth?",
    field_151: "If 'No', enter person 7's gender identity",
    field_152: "Is the gender the person 8 identifies with the same as their sex registered at birth?",
...
private
  ...
  def person_2_present?
    field_47.present? || field_48.present? || field_49.present? || field_140.present? || field_141.present?
  end

  def person_3_present?
    field_51.present? || field_52.present? || field_53.present? || field_142.present? || field_143.present?
  end

  def person_4_present?
    field_55.present? || field_56.present? || field_57.present? || field_144.present? || field_145.present?
  end

  def person_5_present?
    field_59.present? || field_60.present? || field_61.present? || field_146.present? || field_147.present?
  end

  def person_6_present?
    field_63.present? || field_64.present? || field_65.present? || field_148.present? || field_149.present?
  end

  def person_7_present?
    field_67.present? || field_68.present? || field_69.present? || field_150.present? || field_151.present?
  end

  def person_8_present?
    field_71.present? || field_72.present? || field_73.present? || field_152.present? || field_153.present?
  end
