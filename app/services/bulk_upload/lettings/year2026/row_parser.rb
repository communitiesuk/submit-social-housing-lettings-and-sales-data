class BulkUpload::Lettings::Year2026::RowParser
  ...
  QUESTIONS = {
    ...
    field_42: "Which of these best describes the lead tenant’s gender identity?",
    ...
    field_48: "Which of these best describes person 2’s gender identity?",
    ...
    field_52: "Which of these best describes person 3’s gender identity?",
    ...
    field_56: "Which of these best describes person 4’s gender identity?",
    ...
    field_60: "Which of these best describes person 5’s gender identity?",
    ...
    field_64: "Which of these best describes person 6’s gender identity?",
    ...
    field_68: "Which of these best describes person 7’s gender identity?",
    ...
    field_72: "Which of these best describes person 8’s gender identity?",
    ...
    field_115: "What was the source of referral for this letting?",
...
private
  ...
  def validate_leaving_reason_for_renewal
    if field_7 == 1 && ![50, 51, 52, 53].include?(field_97)
  ...
  def validate_cannot_be_la_referral_if_general_needs_and_la
    if field_115 == 4 && general_needs? && owning_organisation && owning_organisation.la?
      errors.add :field_115, I18n.t("#{ERROR_BASE_KEY}.referral.general_needs_prp_referred_by_la")
    end
  end

  def validate_la_with_local_housing_referral
    if field_115 == 3 && owning_organisation && owning_organisation.la?
      errors.add(:field_115, I18n.t("#{ERROR_BASE_KEY}.referral.nominated_by_local_ha_but_la"))
    end
  end
  ...
  def validate_if_log_already_exists
    if log_already_exists?
      ...
      errors.add(:field_42, error_message) # sex1
  ...
  def field_mapping_for_errors
    {
      ...
      referral_type: %i[field_115],
      referral: %i[field_115],
  ...
  def attributes_for_log
    ...
    attributes["sex1"] = field_42
    attributes["sex2"] = field_48
    attributes["sex3"] = field_52
    attributes["sex4"] = field_56
    attributes["sex5"] = field_60
    attributes["sex6"] = field_64
    attributes["sex7"] = field_68
    attributes["sex8"] = field_72
  ...
  def person_2_present?
    field_46.present? || field_47.present? || field_48.present?
  end

  def person_3_present?
    field_50.present? || field_51.present? || field_52.present?
  end

  def person_4_present?
    field_54.present? || field_55.present? || field_56.present?
  end

  def person_5_present?
    field_58.present? || field_59.present? || field_60.present?
  end

  def person_6_present?
    field_62.present? || field_63.present? || field_64.present?
  end

  def person_7_present?
    field_66.present? || field_67.present? || field_68.present?
  end

  def person_8_present?
    field_70.present? || field_71.present? || field_72.present?
  end
  ...
  def referral_type
    ...
    mapping.each do |key, values|
      return key if values.include?(field_115)
    end
