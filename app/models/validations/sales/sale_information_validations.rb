module Validations::Sales::SaleInformationValidations
  ...
  def validate_staircasing_initial_purchase_date(record)
    ...
    if record.saledate.present? && record.initialpurchase > record.saledate
      ...
      record.errors.add :saledate, :skip_bu_error, I18n.t("validations.sales.sale_information.saledate.must_be_after_initial_purchase_date")
    end
  end
  ...
  def validate_staircasing_last_transaction_date(record)
    ...
    if record.saledate.present? && record.lasttransaction > record.saledate
      ...
      record.errors.add :saledate, :skip_bu_error, I18n.t("validations.sales.sale_information.saledate.must_be_after_last_transaction_date")
    end
