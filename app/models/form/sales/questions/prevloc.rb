  ...
  def answer_options
    {
      ...
      "E07000223" => "Adur",
      "E07000026" => ("Allerdale" if form.start_date.year < 2023),
      ...
      "E09000003" => "Barnet",
      "E08000016" => "Barnsley",
      "E07000027" => ("Barrow-in-Furness" if form.start_date.year < 2023),
      "E07000066" => "Basildon",
      ...
      "W06000015" => "Cardiff",
      "E07000028" => ("Carlisle" if form.start_date.year < 2023),
      ...
      "W06000003" => "Conwy",
      "E07000029" => ("Copeland" if form.start_date.year < 2023),
      "E07000150" => "Corby",
      "E06000052" => "Cornwall",
      "E07000079" => "Cotswold",
      "E06000047" => "County Durham",
      "E08000026" => "Coventry",
      "E07000163" => ("Craven" if form.start_date.year < 2023),
      "E07000226" => "Crawley",
      "E09000008" => "Croydon",
      "E06000063" => ("Cumberland" if form.start_date.year >= 2023),
      "E07000096" => "Dacorum",
      ...
      "E07000086" => "Eastleigh",
      "E07000030" => ("Eden" if form.start_date.year < 2023),
      "E07000207" => "Elmbridge",
      "E09000010" => "Enfield",
      ...
      "E09000012" => "Hackney",
      "E06000006" => "Halton",
      "E07000164" => ("Hambleton" if form.start_date.year < 2023),
      "E09000013" => "Hammersmith and Fulham",
      "E07000131" => "Harborough",
      "E09000014" => "Haringey",
      "E07000073" => "Harlow",
      "E07000165" => ("Harrogate" if form.start_date.year < 2023),
      "E09000015" => "Harrow",
      "E07000089" => "Hart",
      ...
      "E06000035" => "Medway",
      "E07000133" => "Melton",
      "E07000187" => ("Mendip" if form.start_date.year < 2023),
      ...
      "E07000166" => ("Richmondshire" if form.start_date.year < 2023),
      "E08000005" => "Rochdale",
      "E07000075" => "Rochford",
      ...
      "E07000092" => "Rushmoor",
      "E06000017" => "Rutland",
      "E07000167" => ("Ryedale" if form.start_date.year < 2023),
      "E08000006" => "Salford",
      "E08000028" => "Sandwell",
      "E07000168" => ("Scarborough" if form.start_date.year < 2023),
      "S12000026" => "Scottish Borders",
      "E07000188" => ("Sedgemoor" if form.start_date.year < 2023),
      "E08000014" => "Sefton",
      "E07000169" => ("Selby" if form.start_date.year < 2023),
      "E07000111" => "Sevenoaks",
      "E08000019" => "Sheffield",
      ...
      "E06000039" => "Slough",
      "E08000029" => "Solihull",
      "E06000066" => ("Somerset" if form.start_date.year >= 2023),
      "E07000246" => ("Somerset West and Taunton" if form.start_date.year < 2023),
      ...
      "E06000064" => ("Westmorland and Furness" if form.start_date.year >= 2023),
      "E08000010" => "Wigan",
      "E06000054" => "Wiltshire",
