class Form::Sales::Subsections::OutrightSale < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      ...
      Form::Sales::Pages::Mortgageused.new("mortgage_used_outright_sale", nil, self, question_number: "Q111"),
      Form::Sales::Pages::MortgageValueCheck.new("outright_sale_mortgage_used_mortgage_value_check", nil, self),
      Form::Sales::Pages::MortgageAmount.new("mortgage_amount_outright_sale", nil, self, question_number: "Q112"),
      Form::Sales::Pages::MortgageValueCheck.new("outright_sale_mortgage_amount_mortgage_value_check", nil, self),
      Form::Sales::Pages::MortgageLender.new("mortgage_lender_outright_sale", nil, self, question_number: "Q113"),
