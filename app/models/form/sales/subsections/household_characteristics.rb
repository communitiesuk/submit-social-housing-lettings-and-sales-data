class Form::Sales::Subsections::HouseholdCharacteristics < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      ...
      Form::Sales::Pages::SexRegisteredAtBirth2.new(nil, nil, self),
      ...
      Form::Sales::Pages::PersonSexRegisteredAtBirth.new("person_2_sex_registered_at_birth", nil, self, person_index: 2),
      ...
      Form::Sales::Pages::PersonSexRegisteredAtBirth.new("person_3_sex_registered_at_birth", nil, self, person_index: 3),
      ...
      Form::Sales::Pages::PersonSexRegisteredAtBirth.new("person_4_sex_registered_at_birth", nil, self, person_index: 4),
      ...
      Form::Sales::Pages::PersonSexRegisteredAtBirth.new("person_5_sex_registered_at_birth", nil, self, person_index: 5),
      ...
      Form::Sales::Pages::PersonSexRegisteredAtBirth.new("person_6_sex_registered_at_birth", nil, self, person_index: 6),
