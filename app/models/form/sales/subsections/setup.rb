class Form::Sales::Subsections::Setup < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      ...
      Form::Sales::Pages::BuyerInterview.new("buyer_interview_joint_purchase", nil, self, joint_purchase: true),
      Form::Sales::Pages::BuyerInterview.new("buyer_interview", nil, self, joint_purchase: false),
      Form::Sales::Pages::PrivacyNotice.new("privacy_notice_joint_purchase", nil, self, joint_purchase: true),
      Form::Sales::Pages::PrivacyNotice.new("privacy_notice", nil, self, joint_purchase: false),
    ].flatten.compact
  end
end
