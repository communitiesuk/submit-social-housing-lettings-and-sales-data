class Form::Sales::Subsections::SharedOwnershipScheme < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      Form::Sales::Pages::LivingBeforePurchase.new("living_before_purchase_shared_ownership", nil, self, question_number: "Q75"),
      ...
      Form::Sales::Pages::Mortgageused.new("mortgage_used_shared_ownership", nil, self, question_number: "Q90"),
      Form::Sales::Pages::MortgageValueCheck.new("mortgage_used_mortgage_value_check", nil, self),
      Form::Sales::Pages::MortgageAmount.new("mortgage_amount_shared_ownership", nil, self, question_number: "Q91"),
      ...
      Form::Sales::Pages::MortgageLender.new("mortgage_lender_shared_ownership", nil, self, question_number: "Q92"),
