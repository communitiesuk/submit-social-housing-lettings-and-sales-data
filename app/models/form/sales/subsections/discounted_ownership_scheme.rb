class Form::Sales::Subsections::DiscountedOwnershipScheme < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      ...
      Form::Sales::Pages::PurchasePrice.new("outright_purchase_price", nil, self),
      Form::Sales::Pages::PurchasePriceDiscountedOwnership.new("purchase_price_discounted_ownership", nil, self),
