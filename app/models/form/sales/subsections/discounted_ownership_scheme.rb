class Form::Sales::Subsections::DiscountedOwnershipScheme < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      Form::Sales::Pages::LivingBeforePurchase.new("living_before_purchase_discounted_ownership", nil, self, question_number: "Q99"),
      ...
      Form::Sales::Pages::Mortgageused.new("mortgage_used_discounted_ownership", nil, self, question_number: "Q103"),
      Form::Sales::Pages::MortgageValueCheck.new("discounted_ownership_mortgage_used_mortgage_value_check", nil, self),
      Form::Sales::Pages::MortgageAmount.new("mortgage_amount_discounted_ownership", nil, self, question_number: "Q104"),
      ...
      Form::Sales::Pages::MortgageLender.new("mortgage_lender_discounted_ownership", nil, self, question_number: "Q105"),
