class Form::Lettings::Subsections::HouseholdCharacteristics < ::Form::Subsection
  ...
  def pages
    @pages ||= [
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckLead.new(nil, nil, self) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 2) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 3) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 4) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 5) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 6) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 7) if form.start_year_2026_or_later?),
      ...
      (Form::Lettings::Pages::WorkingSituationIllnessCheckPerson.new(nil, nil, self, person_index: 8) if form.start_year_2026_or_later?),
    ].compact
  end
