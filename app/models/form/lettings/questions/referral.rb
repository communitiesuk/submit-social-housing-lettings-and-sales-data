class Form::Lettings::Questions::Referral < ::Form::Question
  ...
  ANSWER_OPTIONS = { "1" => { "value" => "Internal transfer" }, "2" => { "value" => "Tenant applied directly (no referral or nomination)" }, "3" => { "value" => "Nominated by a local housing authority" }, "4" => { "value" => "Referred by local authority housing department" }, "8" => { "value" => "Re-located through official housing mobility scheme" }, "10" => { "value" => "Other social landlord" }, "9" => { "value" => "Community learning disability team" }, "14" => { "value" => "Community mental health team" }, "15" => { "value" => "Health service" }, "12" => { "value" => "Police, probation or prison" }, "7" => { "value" => "Voluntary agency" }, "13" => { "value" => "Youth offending team" }, "16" => { "value" => "Other" } }.freeze
end
